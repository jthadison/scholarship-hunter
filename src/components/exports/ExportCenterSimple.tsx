/**
 * ExportCenter Component (Simplified)
 *
 * Modal for exporting scholarship data in various formats.
 * Simplified version without complex date range selection.
 *
...
export function ExportCenter({ open, onClose }: ExportCenterProps) {
  ...
  const handleExportCSV = async () => {
    ...
    try {
      ...
      const applicationsQuery = await trpc.exports.getApplicationsForExport.query({});
  ...
  const handleExportFundingPDF = async () => {
    ...
    try {
      // Fetch data using tRPC client
      const fundingQuery = await trpc.exports.getFundingData.query({});
      const { studentData, fundingData } = fundingQuery;
  ...
  const handleExportAnalyticsPDF = async () => {
    ...
    try {
      // Fetch data using tRPC client
      const analyticsQuery = await trpc.exports.getAnalyticsData.query({});
      const { studentData, analyticsData } = analyticsQuery;
